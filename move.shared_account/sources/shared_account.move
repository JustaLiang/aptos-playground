...
module injoy_labs::shared_account {
    use std::error;
    use std::vector;
    ...
    const ESHARED_ACCOUNT_EVENT_ALREADY_EXISTS: u64 = 3;
    ...
    public entry fun register<CoinType>(resource_addr: address) acquires SharedAccount {
    ...
    #[test_only]
    public entry fun set_up(user: signer, test_user1: signer, test_user2: signer) : address {
        use std::signer;
    ...
    public entry fun test_disperse(user: signer, test_user1: signer, test_user2: signer, core_framework: signer) acquires SharedAccount {
        use std::signer;
    ...
    #[expected_failure]
    public entry fun test_disperse_insufficient_balance(user: signer, test_user1: signer, test_user2: signer) acquires SharedAccount {
